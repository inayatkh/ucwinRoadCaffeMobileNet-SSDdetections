...
try:
    ...
    caffe_root = config['DEFAULT']['caffessd_root_dir'] 
...
if __name__ == '__main__':
    ...
    train_model = './snapshot/mobilenet_iter_{}.caffemodel'.format(train_iter_model)  #Required: Edit this to your snapshot caffemodel
     
    deploy_proto = './example/MobileNetSSD_deploy.prototxt'  
    save_model = './deploy/MobileNetSSD_deploy_{}_{}.caffemodel'.format(train_iter_model,dataset_name) #Optional BUT: Where you want to save the deploy model. MAKE SURE THE DIRECTORY EXISTS BEFOREHAND. CREATE IT MANUALLY
